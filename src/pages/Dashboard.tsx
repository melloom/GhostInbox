...
export default function Dashboard() {
  ...
  const [polls, _setPolls] = useState<PollWithOptions[]>([])
  const [showCreatePoll, setShowCreatePoll] = useState(false)
  const [_pollView, _setPollView] = useState<'all' | 'active' | 'archived'>('all')
  ...
  // Poll status function (for future use)
  // @ts-ignore - intentionally unused for now
  function _getPollStatus(poll: PollWithOptions) {
  ...
  const primaryVentLink = ventLinks[0]
  // Poll-related variables (for future use)
